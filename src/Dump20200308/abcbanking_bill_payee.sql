...
CREATE TABLE `bill_payee` (
  ...
  `payee_phone` varchar(65) NOT NULL,
  `payee_address` varchar(100) NOT NULL,
  `account_no` int(11) NOT NULL,
  PRIMARY KEY (`payee_id`,`user_id`),
...
INSERT INTO `bill_payee` VALUES (333,3,'3333','1234576678','atharvaddress',1111),(444,4,'4444','1234566789','aditaddress',2222);
